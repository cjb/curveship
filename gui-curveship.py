...
class Main():
    ...
    def start_log(self, out_streams):
    ...
    def initialize(self, if_file, spin_files, out_streams):
    ...
    def handle_input(self, user_input, world, discourse, in_stream, out_streams):
        ...
        if user_input.command:
            user_input, id_list, world = self.simulator(user_input, world,
    ...
    def each_turn(self, world, discourse, in_stream, out_streams):
        ...
        if discourse.spin['commanded'] is None:
            ...
            _, id_list, world = self.simulator(None, world,
                                             discourse.spin['commanded'])
            ...
            while len(user_input.tokens) > 0 and world.running:
                (user_input, world, discourse) = self.handle_input(user_input, world,
                                                                   discourse,
                                                                   in_stream,
                                                                   out_streams)
    ...
    def simulator(self, user_input, world, commanded, actions_to_do=None):
    ...
    def teller(self, id_list, concept, discourse):
